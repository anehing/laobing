...
public class PageTag extends TagSupport {
	...
	private String buildPage() {
		...
		pageBuffer.append("<table id=\"pageTable\" width=\"100%\" border=\"0\" class=\"text\">").append("\n");
		pageBuffer.append("<tr><td>&nbsp;</td>").append("\n");

		if (totalPageCount == 0) {
			pageBuffer.append("<td width=\"110\" nowrap=\"nowrap\"><div id=\"currentPageNo\" align=\"right\">").append(currentPageNo).append("/").append("1").append("页</div></td>").append("\n");
		} else {
			pageBuffer.append("<td width=\"110\" nowrap=\"nowrap\"><div id=\"currentPageNo\" align=\"right\">").append(currentPageNo).append("/").append(totalPageCount).append("页</div></td>").append("\n");
		}
		pageBuffer.append("<td width=\"110\" nowrap=\"nowrap\"><div align=\"center\">总数："+totalCount+"&nbsp;&nbsp;</div></td>").append("\n");
		if(currentPageNo > 1){
			pageBuffer.append("<td width=\"50\" nowrap=\"nowrap\"><div align=\"center\"><a href=\"#\" onclick=\"firstPage();\">首页</a></div></td>").append("\n");
		}else{
			pageBuffer.append("<td width=\"50\" nowrap=\"nowrap\"><div align=\"center\">首页</div></td>").append("\n");
		}
		if(currentPageNo > 1){
			pageBuffer.append("<td width=\"50\" nowrap=\"nowrap\"><div align=\"center\"><a href=\"#\" onclick=\"previousPage();\">上一页</a></div></td>").append("\n");
		}else{
			pageBuffer.append("<td width=\"50\" nowrap=\"nowrap\"><div align=\"center\">上一页</div></td>").append("\n");
		}
		if(currentPageNo < totalPageCount){
			pageBuffer.append("<td width=\"50\" nowrap=\"nowrap\"><div align=\"center\"><a href=\"#\" onclick=\"nextPage();\">下一页</a></div></td>").append("\n");
		}else{
			pageBuffer.append("<td width=\"50\" nowrap=\"nowrap\"><div align=\"center\">下一页</div></td>").append("\n");
		}
		if(currentPageNo < totalPageCount){
			pageBuffer.append("<td width=\"50\" nowrap=\"nowrap\"><div align=\"center\"><a href=\"#\" onclick=\"lastPage();\">尾页</a></div></td>").append("\n");
		}else{
			pageBuffer.append("<td width=\"50\" nowrap=\"nowrap\"><div align=\"center\">尾页</div></td>").append("\n");
		}
		pageBuffer.append("<td nowrap=\"nowrap\" align=\"center\" width=\"60\">").append("\n");
		pageBuffer.append("<div align=\"center\">").append("\n");
		pageBuffer.append("<select id=\"pageSize\" name=\"page.pageSize\" ").append(totalPageCount == 0 ? " disabled=\"disabled\" " : "").append(" onchange=\"go(this.value);\" style=\"height:auto;width: 50px;\">").append("\n");
...
//		pageBuffer.append("<option value=\"90\"").append(isSelected(90)).append(">90</option>").append("\n");
		...
		pageBuffer.append("</div></td>").append("\n");		
		pageBuffer.append("<td width=\"110\" nowrap=\"nowrap\">").append("\n");
		pageBuffer.append("<div align=\"right\">").append("\n");
		pageBuffer.append("<input type=\"hidden\" name=\"pageNo\" value=\"").append(currentPageNo).append("\"/>").append("\n");
		pageBuffer.append("<input type=\"text\" ").append(totalPageCount == 0 ? " disabled=\"disabled\" " : "").append(" name=\"jumpPageNo\" id=\"jumpPageNo\" size=\"3\" style=\"font-weight:bold;width: 50px;\"/>").append("\n");
		pageBuffer.append("<input type=\"button\" ").append(totalPageCount == 0 ? " disabled=\"disabled\" " : "").append(" name=\"jumpBtn\" id=\"jumpBtn\" value=\"GO\" onclick=\"jump();\" style=\"width: 40px\"/>").append("\n");
		pageBuffer.append("</div></td></tr></table>").append("\n");
	...
	private String buildScript() {
		...
		scriptBuffer.append("showErrorMsg(\"请输入要跳转的页码!\");return;}").append("\n");
		scriptBuffer.append("if(!checkIsInteger(jumpPageNo)){").append("\n");
		scriptBuffer.append("showErrorMsg(\"页码必须是数字!\");return;}").append("\n");
		scriptBuffer.append("if(jumpPageNo < 1){showErrorMsg(\"页码不能小于1\");return;}").append("\n");
		scriptBuffer.append("if(jumpPageNo > ").append(totalPageCount).append("){").append("\n");
		scriptBuffer.append("showErrorMsg(\"输入的页面超出最大页面范围!\");return;}").append("\n");
