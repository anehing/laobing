...
<body >
	<div class="titleDiv">
		<div class="titleDiv_a">
			<img src="${ctx}/images/tb_1.png" align="absmiddle" /> <span>评论内容</span>
		</div>
		...
		<div class="data0">
			<div class="data1">
				<table class="dataTable" width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
				    	<td width="15%" align="center" class="dataTd" >内容</td>
					    <td width="60%" align="left" class="dataTd">${customer_judge_driver.content}
					    </td>    
				   </tr>
				   <tr>
