...
<body>
	...
	<s:form action="queryDriver_order" method="post" id="form1" enctype ="multipart/form-data" >
         <div id="r0" align="center" >
             <table class="dataTable" width="97%" border="0" align="center" cellpadding="0" cellspacing="1"  bgcolor="#93b5d1">
              <tr>   
		            ...
		            <s:textfield name="driver_order.drivertelphone" id="drivertelphone"></s:textfield>
		            </td>
		          <td width="10%" align="center" bgcolor="#F3F8FE" class="dataTdText">用户手机</td>
		            <td width="30%" align="left" bgcolor="#FFFFFF"> 
		            <s:textfield name="driver_order.customertelphone" id="customertelphone"></s:textfield>
		            </td>
						...
						<s:if test="page.data.size > 0">
							<s:iterator value="page.data" var="t" status="s">
								<tr>
									...
									<td class="dataTd" align="center">
								      <a href="queryDriverorderId.action?totype=1&id=${t.id}">详情</a>
									</td>
								</tr>
							</s:iterator>
						</s:if>
