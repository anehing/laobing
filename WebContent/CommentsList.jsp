...
<center>
<s:form action="queryComments" method="post" id="form1" >
...
<table class="dataTable" width="97%" border="0" align="center" cellpadding="0" cellspacing="1"  bgcolor="#93b5d1">
	...
	<td width="10%" align="center" bgcolor="#F3F8FE"
							class="dataTdText">用户名称</td>
						<td width="25%" align="left" bgcolor="#FFFFFF"><s:textfield
								name="comments.userName"></s:textfield></td>
	<td width="10%" align="center" bgcolor="#F3F8FE"
							class="dataTdText">展品名称</td>
						<td width="25%" align="left" bgcolor="#FFFFFF"><s:textfield
								name="comments.exhibitName"></s:textfield></td>
 ...
 <tr>
 	<td width="10%" align="center" bgcolor="#F3F8FE" class="dataTdText">评论日期</td>
	<td width="25%" align="left" bgcolor="#FFFFFF">
	<s:textfield id="inputDate" name="inputDate"  style="border:1px solid #999;" onclick="fPopCalendar(event,this,this)" onfocus="this.select()" readonly="readonly" /></td>
		   ...
		   <div class="data1">
				<table class="dataTable" width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td class="topTd" align="center" width="12%">用户名</td>
						<td class="topTd" align="center" >用户头像</td>
						<td class="topTd" align="center" width="15%">展品名称</td>
						<td class="topTd" align="center" width="25%">评论内容</td>
						<td class="topTd" align="center" width="20%">评论时间</td>
					...
					<s:if test="page.data.size > 0">
						<s:iterator value="page.data" var="t" status="s">
							<tr>
								...
								<td class="dataTd" align="center" >
									 <img  width="40" height="50" src="${t.userPhotoUrl}	"></img>				
								</td>
								<td class="dataTd" align="center" >
								 	 ${t.exhibitName}
								</td>
								...
								<td class="dataTd" align="center" >
								<textarea rows="3" cols="35" > ${t.content}</textarea>
								...
								<td class="dataTd" align="center" >
									<a href="queryCommentsbyId.action?totype=1&id=${t.id}">修改</a>
									<a href="queryCommentsbyId.action?totype=2&id=${t.id}">删除</a>
								</td>
							</tr>
						</s:iterator>
					</s:if>
