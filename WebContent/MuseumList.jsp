...
<center>
<s:form action="queryMuseums" method="post" id="form1" onsubmit="return toSubmit();">
<div id="r0" align="center" >
<table class="dataTable" width="97%" border="0" align="center" cellpadding="0" cellspacing="1"  bgcolor="#93b5d1">
	<tr>
		<td width="10%" align="center" bgcolor="#F3F8FE" class="dataTdText">中文名称</td>
		<td width="25%" align="left" bgcolor="#FFFFFF">&nbsp;<s:textfield name="museums.chineseName" ></s:textfield></td>
		<td width="10%" align="center" bgcolor="#F3F8FE" class="dataTdText">英文名称</td>
		<td width="25%" align="left" bgcolor="#FFFFFF"> <s:textfield name="museums.englishName" ></s:textfield></td>
		<td rowspan="3" align="center" valign="middle" bgcolor="#FFFFFF">
			<input	type="submit" class="inputBtn"   value="提交" style="cursor: pointer" action="queryMuseums"/>
		    <input	type="button" class="inputBtn"   value="清空" onClick="clearForm('form1')" style="cursor: pointer" />
		</td>
	</tr>
	<tr>
		<td align="center" bgcolor="#F3F8FE" class="dataTdText">分组名称</td>
		
		<td width="35%" class="dataTdText" align="left" bgcolor="#FFFFFF">
			<s:select name="museums.groupId" list="grouplist" listKey="id" listValue="groupName" headerKey="0" headerValue="请选择分组"></s:select>				
		</td>				
		<td align="center" bgcolor="#F3F8FE" class="dataTdText" ></td>
				...
				<table class="dataTable" width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="topTd" align="center" >序号</td>
								<td class="topTd" align="center" width="10%">图片</td>
						<td class="topTd" align="center" width="18%">中文名称</td>
						<td class="topTd" align="center" >英文名称</td>
						<td class="topTd" align="center" width="13%" >分组名称</td>
						<td class="topTd" align="center" >地址</td>
					...
					<s:if test="page.data.size > 0">
						<s:iterator value="page.data" var="t" status="s">
							<tr>
								...
								<td class="dataTd" align="center" >
									<a href="queryMuseumsbyId.action?totype=1&id=${t.id}">修改</a>
									<a href="queryMuseumsbyId.action?totype=2&id=${t.id}">删除</a>
								<a href="queryMuseumsbyId.action?totype=3&id=${t.id}">详细</a>
								</td>
							</tr>
						</s:iterator>
					</s:if>
