...
<center>
<s:form action="queryVideos" method="post" id="form1" onsubmit="return toSubmit();">
<div id="r0" align="center" >
<table class="dataTable" width="97%" border="0" align="center" cellpadding="0" cellspacing="1"  bgcolor="#93b5d1">
	<tr >
		<td width="10%" align="center" bgcolor="#F3F8FE" class="dataTdText">视频名称</td>
		<td width="25%" align="left" bgcolor="#FFFFFF"> <s:textfield name="videos.name" ></s:textfield></td>
		<td width="10%" align="center" bgcolor="#F3F8FE" class="dataTdText">展品名称</td>
		<td width="35%" class="dataTdText" bgcolor="#FFFFFF" align="left">
			<s:select name="videos.exhibitId" list="exhibitsList" listKey="id" listValue="chineseName" headerKey="0" headerValue="请选择分组"></s:select>	
		   ...
		   <div class="data1">
				<table class="dataTable" width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td class="topTd" align="center" >视频名称</td>
						<td class="topTd" align="center" width="25%" >视频文件</td>
						<td class="topTd" align="center" >展品名称</td>
						...
						<s:iterator value="page.data" var="t" status="s">
							 <tr>
 							 ...
 							 ${t.exhibitName}
								...
								<td class="dataTd" align="center" >
									<a href="queryVideosbyId.action?totype=1&id=${t.id}">修改</a>
									<a href="queryVideosbyId.action?totype=2&id=${t.id}">删除</a>
								</td>
							</tr> 
						</s:iterator>
					</s:if>
