...
<center>
<s:form action="queryCollections" method="post" id="form1" onsubmit="return toSubmit();">
...
<table class="dataTable" width="97%" border="0" align="center" cellpadding="0" cellspacing="1"  bgcolor="#93b5d1">
	<tr>
		...
		<td width="25%" align="left" bgcolor="#FFFFFF"> <s:textfield name="collections.userName" ></s:textfield></td>
		<td width="10%" align="center" bgcolor="#F3F8FE" class="dataTdText">展品名称</td>
		<td width="25%" align="left" bgcolor="#FFFFFF"> <s:textfield name="collections.exhibitName" ></s:textfield></td>
		   ...
		   <div class="data1">
				<table class="dataTable" width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td class="topTd" align="center" >收藏用户</td>
					...
					<s:if test="page.data.size > 0">
						<s:iterator value="page.data" var="t" status="s">
							<tr>
								...
								<td class="dataTd" align="center" >
									<a href="queryCollectionsbyId.action?totype=2&id=${t.id}">删除</a>
								</td>
							</tr>
						</s:iterator>
					</s:if>
