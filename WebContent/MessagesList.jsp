...
<center>
<s:form action="queryMessages" method="post" id="form1" >
...
<table class="dataTable" width="97%" border="0" align="center" cellpadding="0" cellspacing="1"  bgcolor="#93b5d1">
	...
	<s:textfield name="messages.userName" id="username"></s:textfield></td>
		<td width="10%" align="center" bgcolor="#F3F8FE" class="dataTdText">留言日期</td>
	<td width="25%" align="left" bgcolor="#FFFFFF">
	<s:textfield id="msgDate" name="msgDate"  style="border:1px solid #999;" onclick="fPopCalendar(event,this,this)" onfocus="this.select()" readonly="readonly" /></td>
		...
		<div class="data0">
		   <div class="data1">
				<table class="dataTable" width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="topTd" align="center"  width="10%">序号</td>
						<td class="topTd" align="center" width="15%">用户名称</td>
						<td class="topTd" align="center"  width="20%">留言日期</td>
						<td class="topTd" align="center"  width="30%">留言内容</td>
						<td class="topTd" align="center"  width="13%">操作</td>
					</tr>
					<s:if test="page.data.size > 0">
						<s:iterator value="page.data" var="t" status="s">
							<tr>
								...
								<td class="dataTd" align="center" >
								<textarea rows="3" cols="50" >  ${t.message}</textarea>
								  
								</td>
								<td class="dataTd" align="center" >
									<a href="queryMessagesbyId.action?totype=1&id=${t.id}">修改</a>
									<a href="queryMessagesbyId.action?totype=2&id=${t.id}">删除</a>
								</td>
							</tr>
						</s:iterator>
					</s:if>
